                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-muted small mt-2"><i class="fa-solid fa-circle-info me-1"></i> Bỏ trống nếu không muốn đổi ảnh.</div>
...
<script>
    function previewImage(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                // Đã chọn ảnh mới thì tắt cờ xóa ảnh
                removeInput.value = "0";
            }
    ...
    function removeImage(event) {
        event.stopPropagation(); // Ngăn mở hộp thoại chọn file
        ...
        // Bật cờ "MUỐN XÓA ẢNH" lên 1 để gửi cho Controller
        removeInput.value = "1";
        
        // Đưa giao diện về trạng thái Đám mây trắng
        preview.src = "";

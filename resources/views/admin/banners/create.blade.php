...
<div class="container-fluid premium-layout" style="font-family: 'Inter', sans-serif;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 fade-in-up" style="animation-delay: 0.1s;">
        <div>
            ...
            <p class="text-muted fw-medium mb-0 ms-5 ps-2">Tải lên hình ảnh trình chiếu cho trang chủ</p>
        </div>
    ...
    {{-- Thêm novalidate để nhường quyền hiển thị lỗi tiếng Việt cho Laravel --}}
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="fade-in-up" style="animation-delay: 0.2s;" novalidate>
        @csrf
        <div class="row g-4">
                ...
                <div class="card premium-card border-0 shadow-sm mb-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg premium-input @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="VD: Khuyến mãi Tết 2026">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg premium-input @error('link') is-invalid @enderror" id="link" name="link" value="{{ old('link') }}" placeholder="VD: https://pickleball.com/sale">
                            <small class="text-muted mt-1 d-block">Khách hàng click vào banner sẽ được chuyển hướng đến link này.</small>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4 mb-md-0">
                                ...
                                <input type="number" class="form-control form-control-lg premium-input @error('position') is-invalid @enderror" id="position" name="position" value="{{ old('position', 0) }}" min="0">
                                {{-- BỔ SUNG HIỂN THỊ LỖI TẠI ĐÂY --}}
                                @error('position') <div class="invalid-feedback fw-medium mt-2">{{ $message }}</div> @enderror
                                <small class="text-muted mt-1 d-block">Số nhỏ hơn sẽ hiển thị trước (0, 1, 2...)</small>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="card premium-card border-0 shadow-sm mb-4">
                    <div class="card-body p-4">
                        <h6 class="fw-bold text-dark mb-4 border-bottom pb-3"><i class="fa-solid fa-image text-info me-2"></i>Hình ảnh Banner <span class="text-danger">*</span></h6>
                        ...
                        <div class="upload-box shadow-sm mb-3 position-relative @error('image') border-danger @enderror" id="upload-box" onclick="document.getElementById('image-input').click()" style="height: 200px; display: flex; flex-direction: column; justify-content: center; overflow: hidden;">
                            ...
                            <div class="upload-content text-center" id="upload-placeholder">
                                ...
                                <p class="text-muted small mb-0">Tỷ lệ khuyến nghị: 1920x600px</p>
                            </div>

                            <img id="image-preview" src="#" alt="Preview" class="d-none position-absolute w-100 h-100" style="object-fit: cover; top: 0; left: 0; border-radius: 14px;">
                        </div>
                ...
                <div class="d-grid gap-3">
                    <button type="submit" class="btn btn-primary btn-lg fw-bold shadow-primary hover-lift" style="border-radius: 12px; background: linear-gradient(135deg, #2563eb, #1d4ed8); border: none;">
                        <i class="fa-solid fa-floppy-disk me-2"></i> Lưu Banner
                    </button>
                </div>
            </div>
        </div>

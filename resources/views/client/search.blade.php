...
@section('title', 'Tìm kiếm: ' . $keyword . ' - PBall Store')
                ...
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm" style="border-radius: 3px;">
                    <div class="filter-col1 p-r-15 p-b-27 w-full">
                        ...
                        <ul class="flex-w">
                            ...
                            @if($currentSort)
                            <li class="p-b-6">
                                <a href="{{ route('search', ['keyword' => $keyword]) }}" class="filter-link stext-106 trans-04" style="color: red; text-decoration: underline;">
                                    Xóa bộ lọc ✖
                                </a>
                            </li>
                            @endif
            ...
            <div class="row">
                ...
                @empty
                    <div class="col-12 p-t-50 p-b-50 txt-center">
                        <p class="stext-106 cl6" style="font-size: 16px;">Hiện không tìm thấy sản phẩm nào phù hợp với từ khóa "<span style="color: red; font-weight: bold;">{{ $keyword }}</span>".</p>
                    </div>
                @endforelse
            </div>
            ...
            @foreach($products as $product)
                @php
                    ...
                    foreach($variants as $v) {
                        ...
                        $variantData[$key] = [
                            'id' => $v->id, // Bổ sung ID để nạp vào giỏ
